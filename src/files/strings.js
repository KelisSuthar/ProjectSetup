...
export const commonNames = {
  ...
  ForgotPassScreeen: 'ForgotPassScreeen',
  ForgotPassScreeen2: 'ForgotPassScreeen2',
  ...
  dont_have_acc: "Don't have an accont?",
  already_have_acc: 'Already have an account?',
  reset_password: 'Reset \nPassword',
  by_signin: 'By signin you are accepting our',
  t_and_c: '\nTerms & Conditions',
  enter_new_pass: 'Enter your new password',
  forgot_pass_heading:
    "Enter the email addres you've registered with. We'll send you an email in order to let you choose a new password.",
  next: 'Next',
  send: 'Send',
};
...
export const ErrorMessages = {
  ...
  country_empty: 'Please select country',
  DOB_empty: 'Please select DOB',
  new_pass_empty: 'Please Enter New Password',
  new_pass_valid: 'Please Enter Valid New Password',
  con_pass_empty: 'Please Enter Confirm Password',
  con_pass_valid: 'Please Enter Valid Confirm Password',
  con_new_pass:'New Password and Confirm Password must be same',
};
